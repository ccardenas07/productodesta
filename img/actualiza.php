...
if(!empty($_FILES["foto"]["name"])and empty($_FILES["foto2"]["name"])and empty($_FILES["foto3"]["name"])and empty($_FILES["foto4"]["name"]))
		...
		$sql="update descripcion set titulo='".$_POST["textotit"]."', textdes='".$_POST["editor"]."',textoacc='".$_POST["sencillo"]."',image1='$nombre_foto',image2='$image2',image3='$image3',image4='$image4',date='".$_POST["datehost"]."',user='".$_SESSION['admin']."',host='".$_SERVER['REMOTE_ADDR']."',enlace='".$_POST["enlace"]."' where id=".$_POST["id"]." ";
